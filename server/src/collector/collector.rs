...
use crate::collector::collector_utils;
use crate::collector::collector_utils::{Device, Proc};
...
fn collect_metrics() {
    ...
    // Collect Memory Info (Most of this is unnecessary. Its just there bc I'm trying to
